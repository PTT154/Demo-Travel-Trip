...
import SplitSectionHeader from '@/components/heading-title-group/split-section-header/split-section-header';
...
export default function TourTypes({ data }: TourTypesProps) {
  return (
